...
public class NonIntiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.nonIntiListView);
        getJSON();
    }
        ...
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    ...
                    Log.e("NonIntiActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] nonInti = new String[jsonObject.length()];

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            nonInti[i] = jsonObject.getString(String.valueOf(i+1));
        }

        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, nonInti) {
            @NonNull
            @Override
